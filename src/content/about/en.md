...
# Fill in each section below. Remove a whole section to hide it (heading included).
...
# Internship
internship:
  - company: Huawei · Multimedia Intelligent Collaboration Lab
    period: "2026.01 - 2026.04"
    description: Participated in and designed the Multi-Agent collaboration architecture. Built with LangGraph orchestration, implemented A2A protocol for cross-agent dynamic service discovery and decoupled invocation; optimized semantic routing to prevent false triggers; built LLM-as-a-Judge automated evaluation pipeline.

# Research & Projects
research:
  - title: Multi-Agent Interpretable Diagnostic Framework
    role: Principal Investigator
    period: "2025.09 - Present"
    description: To address the difficulty of predicting treatment efficacy for rare diseases, building a multi-agent interpretable algorithm architecture that simulates the multi-source diagnostic process of clinical pathologists. Using Agent Workflow for medical data preprocessing, pretrained medical LLMs for feature extraction, and mid-fusion architecture for cross-modal information complementarity.
  - title: '"Intelligent Autonomous Systems" Research Group'
    role: Core Member
    period: "2023.08 - 2024.08"
    description: 'Engaged in literature research on "Robot Learning Methods Combining LLMs and RL". Participated in the "Autonomous Behavioral Learning for Social Robot Haru" project, setting up ROS environment and conducting Gazebo simulations.'
  - title: "Innovation Project: STM32 Intelligent Desktop System"
    role: Project Leader
    period: "2022.11 - 2023.11"
    description: Led the project to design a multifunctional human-computer interaction desk system. Used Keil C for the control framework, optimizing voice control polling with hash thinking and function pointers.

# Awards & Honors (desc optional)
awards:
  - title: Fudan University Xianghui Doctoral Scholarship
    desc: Fudan University
  - title: First-Class Scholarship
    desc: Ocean University of China
  - title: Outstanding Student
    desc: Ocean University of China
  - title: Huawei HSD Certificate

# Skills (grouped; items use bracket arrays)
skills:
  - name: AI-Native Dev
  ...
  - name: General
    items: [C/C++, MATLAB, "CET-6: 622", "CET-4: 657", Putonghua 2A]
---
